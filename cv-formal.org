...
with the computer by providing the ability to produce new texts in
response to prompts. Fundamental research in this area is at the core of
my expertise, I've been doing this since my own PhD in the 1990s. This pre-dated LLMs, but the idea of linking language to meanings remains the same.
...
* Academic publications
  ...
  :CLASS: unnumbered
  :END:
Over 140 academic publications with 4129 citations in total, see a separate list below.

[[https://scholar.google.co.uk/citations?user=qcnf4QsAAAAJ]]

I'm on the editorial board of Language Resources and Register Studies.
...
* PhD Supervision
  ...
  :CLASS: unnumbered
  :END:
19 students supervised to successful completion.
